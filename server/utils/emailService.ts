  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
        ...
        <p style="font-size: 16px; line-height: 1.6;">To stay updated on the latest developments and announcements, make sure to check our updates page at <a href="https://flohub.replit.app/updates" style="color: #0D9488; text-decoration: underline;">flohub.replit.app/updates</a>. We'll be posting regular progress updates there!</p>
